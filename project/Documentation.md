...
The client is UWC ISAK Japan school. My client is an ESS student who wants to collect data for knowing what weather conditions help the plant to grow. He wants to conduct this experiment throughout the school year therefore he wants the system to be durable with the range of temperature and humidity for any possible weather. In addition, he wants to visualize the temperature and humidity. He requests that the cost be low because he is a student and wouldn’t be able to afford an expensive system. 
